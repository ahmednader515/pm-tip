    ...
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{t("passwordsTitle")}</h1>
            </div>
                                ...
                                {staffUsers.map((user) => (
                                    <TableRow key={user.id}>
                                        ...
                                        <TableCell>
                                            ...
                                            >
                                                {user.role === "TEACHER" ? tCommon("roleTeacher") : 
                                                 user.role === "ADMIN" ? tCommon("roleAdmin") : user.role}
                                            </Badge>
                                        </TableCell>
                                        <TableCell>
                                            <Button 
                                            ...
                                            >
                                                <Edit className="h-4 w-4" />{t("changePassword")}</Button>
                                        </TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>
                            {t("changePasswordFor", { name: selectedUser?.fullName })}
                        </DialogTitle>
                    </DialogHeader>
